...
const Interview = () => {
    ...
    if (loading) {
        return <div className='interview-page'><p>Loading report...</p></div>
    }

    if (error || !report) {
        return <div className='interview-page'><p>{error || "Report not found."}</p></div>
    }
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <button
                        ...
                        className={`button primary-button has-loading-state ${isDownloading ? 'is-loading' : ''}`} >
